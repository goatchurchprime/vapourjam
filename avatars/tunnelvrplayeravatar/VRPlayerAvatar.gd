...
func PF_processlocalavatarposition(delta):
	...
	$hand_l.transform = arvrorigin.global_transform.inverse()*LeftHandController.get_node("LeftPhysicsHand/Hand_Glove_L").global_transform
	skelbonescopy($hand_l/Armature/Skeleton3D, LeftHandController.get_node("LeftPhysicsHand/Hand_Glove_L/Armature/Skeleton3D"))
	$hand_r.transform = arvrorigin.global_transform.inverse()*RightHandController.get_node("RightHand/Hand_low_R").global_transform
	skelbonescopy($hand_r/Armature/Skeleton3D, RightHandController.get_node("RightHand/Hand_low_R/Armature/Skeleton3D"))
	if projectedhands:
